...
public class xdelta3
{
    ...
    /// </summary>
    static readonly int MAX_BUFFER = 256 * 1024 * 1024; // 256 MB
    ...
    [DllImport("__Internal", EntryPoint = "xd3_encode_memory", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("__Internal", EntryPoint = "xd3_decode_memory", CallingConvention = CallingConvention.Cdecl)]
